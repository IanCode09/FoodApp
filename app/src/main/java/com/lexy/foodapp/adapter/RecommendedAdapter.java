...
public class RecommendedAdapter extends RecyclerView.Adapter<RecommendedAdapter.RecommendedViewHolder> {
    ...
    public static class RecommendedViewHolder extends RecyclerView.ViewHolder {
        ...
        public RecommendedViewHolder(@NonNull View itemView) {
            ...
            recommendedImage = itemView.findViewById(R.id.recommend_img);
            ...
            recommendedDeliveryTime = itemView.findViewById(R.id.recommend_delivery_time);
            recommendedCharges = itemView.findViewById(R.id.delivery_type);
            recommendedPrice = itemView.findViewById(R.id.recommend_price);
        }
    }
}
